...
add_action( 'admin_head-nav-menus.php', function() {
	add_meta_box( 'add-cpt', __("Archiefpagina's", 'od'), 'wp_nav_menu_cpt_archives_meta_box', 'nav-menus', 'side', 'default' );
});
...
function wp_nav_menu_cpt_archives_meta_box() {
	...
	foreach ( $post_types as &$post_type ) {
		...
		$post_type->title 		= $post_type->labels->name.' '.__('Archief', 'od');
